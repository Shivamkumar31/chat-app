...
const handleSendMessage = async (e) => {
  ...
  await sendMessage({
    text: input.trim(),
    to: selectedUser._id   // ✅ send to specific user
  });
  ...
  {messages.map((msg, index) => (
    ...
    >
      {msg.image ? (
        ...
        <p
          className={`p-2 max-w-[200px] md:max-w-[300px] text-sm font-light rounded-lg mb-8 break-all bg-violet-500/30 text-white ${
